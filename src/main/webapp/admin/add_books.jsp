...
enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input name="author" type="text" class="form-control" id="exampleInputEmail1" required="required">
  </div>
  
  
    <div class="form-group">
    <label for="exampleInputEmail1">Price</label>
    <input name="price" type="number" class="form-control" id="examplePassword1" aria-describedby="emailHelp" required="required" >
  ...
  <div class="form-group">
    ...
    <input name="bimg" type="file" class="form-control-file" id="exampleFormatFile1">
  </div>
